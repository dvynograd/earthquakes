...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker> {
	...
	public boolean isInThreatCircle(Marker marker) {
		return this.getDistanceTo(marker.getLocation()) < this.threatCircle();
	}
	...
	public static Comparator<EarthquakeMarker> depthComparator = new Comparator<EarthquakeMarker>() {
		public int compare(EarthquakeMarker quake1, EarthquakeMarker quake2) {
			if (quake1.getDepth() < quake2.getDepth()) {
				return 1;
			} else if (quake1.getDepth() > quake2.getDepth()) {
				return -1;
			} else {
				return 0;
			}
